 ...
 * 
 * Handles parsing search queries and matching related terms
 */

/**
 * Parse search query for special operators like +required -excluded terms
 */
...
/**
 * Mapping of job terms to related synonyms
 */
export const relatedTerms: Record<string, string[]> = {
  ...
  'sales': ['business development', 'account management', 'selling', 'revenue'],
  'frontend': ['front-end', 'ui', 'client-side', 'web development'],
 ...
 */
export function matchesRelatedTerm(jobText: string, term: string): boolean {
